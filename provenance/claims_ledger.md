...
**C11 (2026-07-03, supersedes C7 as headline).** Actual-effort bare size law, n=17, protocol-consistent
sizing (each point at its spec-declared `sizing_mode`; Subsquare & dotreasury at CI-measured window churn):
**PM = 0.283·KSLOC^0.914; r = 0.731; LOOCV SA = +0.176; PRED(30) = 35 %; MdMRE = 47 %.** Produced by the
