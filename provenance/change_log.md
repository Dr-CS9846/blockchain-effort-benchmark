...
- Next: push -> dispatch paper-stats in CI -> read reports/paper_stats_pm_mid.json from census -> backfill every [COMPUTE] in both manuscripts with the real, reproducible numbers.
