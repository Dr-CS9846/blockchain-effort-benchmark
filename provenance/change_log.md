...
- Next: push -> dispatch documented-effort -> read documented_effort.csv -> assess coverage of team_size / explicit documented PM; then build the latent true-effort model (Step 3) using {git PM, planned PM, cost PM, documented PM, team_size} as indicators.
