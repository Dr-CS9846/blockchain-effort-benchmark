...
- Next: push -> re-dispatch treasury-mine -> read coverage (ANY effort / FTE-duration / team / explicit-PM / repo+plan). Use the human-stated effort pool (repo-matched for size calibration; standalone as reported-effort anchors).
