...
- Next: push -> dispatch activity-pm -> read activity_pm.csv -> see how much of the ground-truth problem is fixed by measuring better, before invoking the latent model (Step 3) and the external anchor (Step 4).
