...
- Next: push -> re-dispatch treasury-mine -> read coverage (with content / FTE-duration / team / explicit-PM / ANY effort / repo+plan) + the stderr first-item keys to confirm Subsquare shape.
